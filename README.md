...
- **Rich Markdown Formatting:** Suggestions are rendered with proper Markdown support, including headers, bullet points, and code blocks for maximum readability.
...
- **Visual Polish:**
  ...
  - **3D Brain Loader:** A procedural 3D brain animation keeps users engaged while waiting for AI analysis.
...
3.  **Display:** While loading, a 3D procedural brain animation plays. Once ready, suggestions are listed with titles and confidence scores.
4.  **Interaction:**
    - Click a card to see the **Detailed View** (full description rendered in Markdown).
...
- **CI/CD:** GitHub Actions (Node 20.x, Forge CLI latest)
