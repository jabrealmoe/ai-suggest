...
=======
                    Dr. Jira Admin <span style={{ fontSize: '12px', background: '#DEEBFF', color: '#0747A6', padding: '2px 6px', borderRadius: '4px', verticalAlign: 'middle' }}>v3.1 (DEV)</span>
>>>>>>> dev
                </h1>
            </div>
...
=======
            ...
            <h3 style={{ marginTop: '40px', marginBottom: '20px', fontSize: '18px', color: 'var(--ds-text, #172B4D)', borderBottom: '1px solid var(--ds-border, #dfe1e6)', paddingBottom: '10px' }}>
                Suggestion Usage Report
            </h3>
            ...
            {loadingReport ? (
                ...
                !reportData || Object.keys(reportData).length === 0 ? (
                    ...
                    <div style={{ background: 'var(--ds-surface, #fff)', borderRadius: '8px', border: '1px solid var(--ds-border, #dfe1e6)', padding: '16px' }}>
                        {Object.entries(reportData).sort((a, b) => b[1] - a[1]).map(([model, count]) => {
                            ...
                            return (
                                <div key={model} style={{ marginBottom: '16px' }}>
                                    ...
                                    <div style={{ width: '100%', height: '8px', background: 'var(--ds-surface-overlay, #F4F5F7)', borderRadius: '4px', overflow: 'hidden' }}>
                                        <div style={{ width: `${percentage}%`, height: '100%', background: 'var(--ds-background-brand-bold, #0052CC)', borderRadius: '4px' }}></div>
                                    </div>
                                </div>
                            );
                        })}
                        <div style={{ marginTop: '20px', paddingTop: '10px', borderTop: '1px solid var(--ds-border, #ebecf0)', textAlign: 'right', fontSize: '12px', color: 'var(--ds-text-subtle, #5E6C84)' }}>
                            Total Suggestions Applied: <strong>{totalUsage}</strong>
                        </div>
                    </div>
                )
>>>>>>> dev
